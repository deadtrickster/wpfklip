...
namespace WpfKlip.Core
{
    class CapturedItemsListController
    {
        ...
        static CapturedItemsListController instance = new CapturedItemsListController(Application.Current.MainWindow as MainWindow);

        internal static CapturedItemsListController Instance
        {
            get { return CapturedItemsListController.instance; }
            set { CapturedItemsListController.instance = value; }
        }
        ...
        public CapturedItemsListController(MainWindow mainWindow)
        {
